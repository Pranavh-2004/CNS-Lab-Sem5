...
def extract_hex_from_txt():
    ...
    print("    OR")
    print("    tshark -r <pcap> -Y 'frame.number==73' -x | grep -A20 'Data'")
...
def main():
    ...
    encrypted_candidates = [
        # Original attempt
        ("Hex interpretation 1", "44f374219fb8f1f9e0e12833cfe84ee7"),
        # Maybe the TXT data is actually different - let's try the visible chars
        # "D�t!������(3��N�" - trying different encodings
    ]
    ...
    print("\n[!] Please extract the exact hex bytes from Frame 73's TXT record")
    print("[!] and update the 'encrypted_candidates' list in the script.")
